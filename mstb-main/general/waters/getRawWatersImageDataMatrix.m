function [MZ,X,xy,xy2D] = getRawWatersImageDataMatrix(filename,mztol,mzfrac,wb,peakDetect)
...
%% Authors: Kirill A. Veselkov and Keith Richardson, Imperial College Londond & Waters Corporation, 2015. 
