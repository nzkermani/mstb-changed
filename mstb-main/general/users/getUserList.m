function [ flag ] = getUserList
% Read a list of approved users and determine if this user is one of them


page = {'https://docs.google.com/spreadsheets/d/';...
    '1FjiHPuaduSkAEXzQ827f0SqcRuiHianLPcC6L7NyuWU';'/';...
    'edit?usp=sharing'};

% Read in the document
result = GetGoogleSpreadsheet(page{2});

% Compare list of approved users to me...
flag = any(strcmp(result,getUser));
