function [ell,xy,ab] = error_ellipse(data,confLim)
...
allVals = sqrt([10.597 9.210 5.991 4.605]);% 99.5 99%, 95%, 90%
switch confLim
    case 99.5
        chisquare_val = allVals(1);
    case 99
        chisquare_val = allVals(2);
    case 95
        chisquare_val = allVals(3);
    case 90
        chisquare_val = allVals(4);
end
...
% Return the ellipse
ell = bsxfun(@plus,r_ellipse,[X0 Y0]);
xy = [X0 Y0];
