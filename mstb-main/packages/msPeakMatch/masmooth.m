...
if nargin<4 || isempty(method)
    ...
    switch method
        ...
        case 'sgolay'
            runSgolay = true;
        otherwise
            error(message('bioinfo:masmooth:UnknownSmoothingMethod'))
    end
end
    ...
    if nargin<6 || isempty(weighting)
        ...
        switch weighting
            ...
            case 'linear'
                weighting = 1;
            otherwise
                error(message('bioinfo:masmooth:UnknownWeightingMethod'))
        end
    end
end
...
if (weighting == 2) && (span-1 <= order)
    span = order+2;
    warning(message('bioinfo:masmooth:SmallSpanGaussianWeighting', span))    
elseif span-2 <= order
    span = order+3;
    warning(message('bioinfo:masmooth:SmallSpanTricubicWeighting', span))
end
